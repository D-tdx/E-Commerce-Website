            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="right-phone-box">
                        <p>Call US :- <a href="#"> +91 6290747648 </a></p>
                    </div>
                    <div class="our-link">
                        <ul>
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                ...
                                <li>
                                    <i class="fab fa-opencart"></i> 50% - 80% off on New Seasons Jersey
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Off 10%! Shop Spikes
                                </li>
                                <li>
                    ...
                    <div class="row">
                            ...
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.html"> Germany 22/23 </a>
                                            <div class="small text-muted">Price: ₹1200 </div>
                                        </div>
                                    </div>
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.html"> Nike Vapor Edge </a>
                                            <div class="small text-muted">Price: ₹1300 </div>
                                        </div>
                                    </div>
                                    <div class="media mb-2">
                                        <div class="media-body"> <a href="detail.html"> Al Nassr 22/23, Ronaldo </a>
                                            <div class="small text-muted">Price: ₹1500 </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                ...
                                <div class="d-flex">
                                    <h4>Sub Total</h4>
                                    <div class="ml-auto font-weight-bold"> ₹ 4000</div>
                                </div>
                                <div class="d-flex">
                                    <h4>Discount</h4>
                                    <div class="ml-auto font-weight-bold"> ₹ 400 </div>
                                </div>
                                <hr class="my-1">
                                <div class="d-flex">

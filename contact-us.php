...
<head>
    ...
    <!-- Site Metas -->
    <title>Kitstore-Contact_us</title>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>We will be glad to help you out with your inquiries and suggestions. <p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a href="mailto:contactinfo@gmail.com">dbiswasdrt1@g@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
